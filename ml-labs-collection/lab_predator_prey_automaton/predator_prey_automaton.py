...
def step(layer1, layer2):
    ...
    born1 = ~alive1 & (n1 == 3) & ~herbivore_here
    new_l1 = (survive1 | born1).astype(np.int8)

    #Правила для слоя 2 (травоядные):
    #Живое травоядное выживает, если 1–5 соседей-травоядных (живучие)
...
def run_simulation():
    ...
    for t in range(1, MAX_STEPS + 1):
        layer1, layer2 = step(layer1, layer2)
...
def visualize(saved, pop1, pop2):
    ...
    plt.savefig('tz3_result.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("\nГрафик сохранён: tz3_result.png")
